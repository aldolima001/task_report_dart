import '../lib/tarefa.dart';
import '../lib/tratamento_dados_api.dart';
import '../lib/relatorio_operacional.dart';
...
void main() {
  ...
  List<Tarefa> tarefasProntas = TratamentoDadosAPI.paraListaDeTarefas(dadosTarefas);
  
  RelatorioOperacional.exibir(tarefasProntas);
}